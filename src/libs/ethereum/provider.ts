...
const MAINNET_KEY = process.env.REACT_APP_MAINNET_KEY
...
const KOVAN_KEY = process.env.REACT_APP_KOVAN_KEY
...
export const fromEnvironment = () => {
  if (process.env.REACT_APP_STAGING_MATIC_USD) return kovan
